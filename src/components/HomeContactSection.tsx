    ...
    return (
      <section className="py-20 bg-gradient-to-br from-sage/10 to-clay/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white/80 backdrop-blur-sm p-12 rounded-2xl border border-sage/20 shadow-gentle">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={3}
                  className="w-full px-4 py-3 rounded-lg border border-sage/20 focus:border-sage focus:ring-2 focus:ring-sage/20 transition-colors font-karla text-sm resize-none"
