  ...
  const desserts = [
    {
      ...
      description: "Delicate sponge infused with bergamot, kissed with lavender cream",
    ...
    },
    {
      ...
      description: "Buttery pastry shells filled with bright lemon curd and fresh thyme sugar",
    ...
    },
    {
      ...
      description: "Crumbly, golden cookies with wildflower honey and garden rosemary",
    ...
    },
    {
      ...
      description: "Silky custard with Madagascar vanilla, topped with seasonal fruit",
    ...
    },
    {
      ...
      description: "Delicate shells filled with rose-scented buttercream and almond",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-6">
            ...
            <span className="mx-4 text-sm font-karla text-sage/70 uppercase tracking-wider">Menu</span>
            <div className="w-16 h-px bg-sage/40"></div>
          </div>
          ...
          <p className="text-lg text-mocha/70 max-w-2xl mx-auto font-karla font-light leading-relaxed">
            ...
            <span className="block mt-2 italic text-mocha/60">
              Every bite tells a story of careful attention and genuine love for the craft.
            </span>
          </p>
        </div>
