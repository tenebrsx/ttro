        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-4xl sm:text-5xl font-cormorant text-mocha mb-8 text-shadow-soft">
              Hola, soy el corazón
              <span className="block text-sage italic">detrás de Cucinanostrard</span>
            </h2>
            
            <div className="space-y-6 text-mocha/80 text-lg leading-relaxed font-karla font-light">
              <p>
                Lo que comenzó como sesiones de repostería los domingos por la tarde se ha convertido 
                en algo hermoso—crear momentos dulces que se convierten en recuerdos entrañables.
              </p>
              
              <p>
                En mi cocina, trabajo con ingredientes de temporada y técnicas consagradas, 
                elaborando cada postre a mano. Sin atajos, sin sabores artificiales—solo 
                ingredientes puros transformados en algo mágico.
              </p>
            </div>
            ...
            <div className="mt-10 p-6 bg-white/40 backdrop-blur-sm rounded-2xl border border-sage/10">
              <blockquote className="text-2xl font-cormorant text-sage italic text-center">
                "No solo horneo—
                <span className="block mt-1">creo pequeños momentos comestibles."</span>
              </blockquote>
            </div>
            ...
            <div className="mt-8">
              <Link 
                to="/about"
                className="inline-block text-sage hover:text-mocha transition-colors duration-300 font-karla font-medium"
              >
