        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            <div className="flex items-center mb-4">
              ...
              <span className="mx-4 text-sm font-karla text-dusty-rose/70 uppercase tracking-wider">Acerca de</span>
              <div className="w-12 h-px bg-dusty-rose/40"></div>
            </div>
            
            <h2 className="text-4xl sm:text-5xl font-cormorant text-mocha mb-8 text-shadow-soft">
              Hola, soy el corazón
              <span className="block text-dusty-rose italic">detrás de Cucinanostrard</span>
            </h2>
