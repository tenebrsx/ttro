      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-6">
            ...
            <span className="mx-4 text-sm font-karla text-sage/70 uppercase tracking-wider">Testimonios del Corazón</span>
            <div className="w-16 h-px bg-sage/40"></div>
          </div>
          
          <h2 className="text-4xl sm:text-5xl font-cormorant text-mocha mb-6 text-shadow-soft">
            Palabras que Abrazan el Alma
          </h2>
          ...
          <p className="text-lg text-mocha/70 max-w-2xl mx-auto font-karla font-light leading-relaxed">
            ...
            de los recuerdos más preciados de alguien.
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white/80 backdrop-blur-sm p-8 rounded-lg shadow-gentle hover:shadow-warm transition-all duration-300 border border-sage/10 group">
        ...
        <div className="text-center mt-16">
          <div className="bg-sage/10 p-8 rounded-lg shadow-gentle max-w-2xl mx-auto">
            <p className="text-mocha/70 font-karla font-light leading-relaxed mb-4">
              "Cada testimonio es un recordatorio de por qué hago lo que hago. 
              No solo creo postres, creo momentos que permanecen en el corazón para siempre."
            </p>
