        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                <div className="mb-8">
                  <h2 className="text-2xl font-playfair text-dark-cocoa mb-4">
                    Cuéntame sobre tu evento
                  </h2>
                  <p className="text-mocha/70 font-source-serif font-light">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-dusty-rose text-white py-3 px-6 rounded-lg font-medium hover:bg-dusty-rose/90 transition-colors duration-300 flex items-center justify-center space-x-2 shadow-gentle hover:shadow-soft"
                  >
              ...
              >
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-3xl p-8 border border-green-200">
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-xl font-playfair text-green-800">
                        Respuesta inmediata
                      </h3>
                ...
                {/* Contact Information */}
                <div className="bg-white rounded-3xl shadow-gentle p-8 border border-dusty-rose/10">
                  <h3 className="text-xl font-playfair text-dark-cocoa mb-6">
                  ...
                  <div className="space-y-4">
                    {contactInfo.map((item, index) => (
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm font-medium text-mocha/60">
                            {item.title}
                          </p>
                          <p className="text-mocha font-source-serif">
                            {item.value}
                          </p>
                        </div>
                      </a>
                ...
                <div className="bg-white rounded-3xl shadow-gentle p-8 border border-dusty-rose/10">
                  ...
                  <div className="space-y-2 text-mocha/70 font-source-serif">
                  ...
                  <div className="mt-6 p-4 bg-dusty-rose/10 rounded-lg">
                    <p className="text-sm text-mocha/80 font-source-serif font-light">
