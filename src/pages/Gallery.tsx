                  ...
                  <button
                    ...
                    className={`px-6 py-2 rounded-full font-karla transition-all duration-300 ${
                      activeCategory === category.id
                        ? "bg-dusty-rose text-cream shadow-gentle"
                        : "bg-cream/60 text-mocha/70 hover:bg-dusty-rose/20"
                    }`}
                  >
                    {category.name}
                  </button>
        ...
        <section className="py-20 bg-gradient-to-br from-cream to-white bg-texture">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a
              ...
              className="inline-block bg-dusty-rose text-cream px-10 py-4 rounded-full text-lg hover:bg-mocha transition-all duration-500 transform hover:scale-105 shadow-gentle hover:shadow-soft font-karla font-medium"
            >
              @cucinanostrard
            </a>
          </div>
